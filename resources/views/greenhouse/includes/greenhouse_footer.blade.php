    ...
    <div class="container">
     <div class="row">
      <div class="col-md-6 aside-stretch py-3">
        ...
        <p class="mb-0">
          Copyright &copy;<script>document.write(new Date().getFullYear());</script> All rights reserved | Made with <i class="fa fa-heart" aria-hidden="true"></i> by <a href="https://BashinskyFedor.com" target="_blank">Bashinsky</a>
        </p>
        </div>
      </div>
    </div>
